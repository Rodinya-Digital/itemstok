      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input v-bind:class="{'is-invalid': errors.surname}" type="text" v-model="surname" class="form-control">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input v-bind:class="{'is-invalid': errors.email}" type="text" v-model="email" class="form-control"
                     v-if="$parent.userCan('edit-users')">
              <input v-bind:class="{'is-invalid': errors.email}" type="text" v-model="email" class="form-control"
                     disabled v-else>
          ...
          <div class="form-group row mb-4" v-if="$parent.userCan('edit-users') && !getUserdata('isme')">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">用户状态</label>
            <div class="col-sm-12 col-md-7">
              <select class="form-control" v-model="status" v-bind:class="{'is-invalid': errors.status}">
                <option v-bind:value="1">不禁止</option>
                <option v-bind:value="0">禁止</option>
              </select>
              <div class="invalid-feedback" v-if="errors.role">
                <p>{{ errors.role[0] }}</p>
              </div>
          ...
          <div class="form-group row mb-4" v-if="!$parent.userCan('edit-users')">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">当前密码</label>
            <div class="col-sm-12 col-md-7">
              <input v-bind:class="{'is-invalid': errors.current_password}" type="password" v-model="current_password"
                     class="form-control" autocomplete="new-password" placeholder="当前密码">
          ...
          <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">新密码</label>
            <div class="col-sm-12 col-md-7">
              <input v-bind:class="{'is-invalid': errors.password}" type="password" v-model="password"
                     class="form-control" autocomplete="new-password"
                     placeholder="New Password (Leave this blank if you are not going to change your password)">
          ...
          <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">新密码重复</label>
            <div class="col-sm-12 col-md-7">
              <input v-bind:class="{'is-invalid': errors.password_confirmation}" type="password"
                     v-model="password_confirmation" class="form-control" autocomplete="new-password">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <button v-bind:disabled="loading" @click="updateUser" class="btn btn-primary"><span v-if="loading">更新中...</span><span
                  v-else>更新</span></button>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      surname: this.getUserdata('surname'),
  ...
  methods: {
    ...
    updateUser() {
      ...
      _this.message = '';
      _this.loading = true;
      axios.post(this.$parent.MakeUrl('panel/users/' + this.getUserdata('id')), {
        'name': this.name,
        ...
        _this.loading = false;
        _this.message = 'Profile update successful!';
      }).catch((err) => {
