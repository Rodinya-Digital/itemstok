...
return [
    ...
    */
    ...
    'custom' => [
        'phone' => [
            'regex' => 'Lütfen geçerli bir telefon numarası giriniz örn:90532xxxxxxx',
        ],
        'password' => [
            'confirmed' => 'Parola ve parola tekrarı alanı aynı olmalıdır.',
        ...
        'role' => [
            'required' => 'Kullanıcı tipi alanı gereklidir.',
        ],
    ],
