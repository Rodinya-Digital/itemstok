...
document.addEventListener("DOMContentLoaded", function (t) {
    var e;
    e = document.getElementById("form-add-new-record"), setTimeout(() => {
        const t = document.querySelector(".create-new"), e = document.querySelector("#add-new-record");
    ...
    }, 200), fv = FormValidation.formValidation(e, {
        fields: {
    ...
    }), (e = document.querySelector('[name="basicDate"]')) && e.flatpickr({
        enableTime: !1,
        dateFormat: "m/d/Y",
        onChange: function () {
    ...
    var i, e, t = $(".datatables-basic"), a = $(".dt-complex-header"), s = $(".dt-row-grouping"),
        n = $(".dt-multilingual"), l = (t.length && (i = t.DataTable({
            ...
            columnDefs: [{
                ...
                render: function (t, e, a, s) {
                    var n = a.avatar, i = a.full_name, l = a.post;
                ...
                targets: -2, render: function (t, e, a, s) {
                    var a = a.status, n = {
                ...
                targets: -1, title: "Actions", orderable: !1, searchable: !1, render: function (t, e, a, s) {
